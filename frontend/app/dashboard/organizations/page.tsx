...
import { CheckCircle2, Globe, Building2, Plus } from "lucide-react";
      ...
      {isLoading ? (
        <div className="grid md:grid-cols-3 gap-6">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="h-40 rounded-3xl bg-muted/50 animate-pulse border-2 border-dashed border-border"
            />
          ))}
        </div>
            ...
            return (
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    <h2 className="text-lg font-bold truncate leading-tight text-foreground">
                      {org.name}
                    </h2>
